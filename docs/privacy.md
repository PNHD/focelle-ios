...
- Camera frames used for continuous composition guidance are analyzed on the device and are not retained by Focelle.
- Photos are saved to the user's Apple Photos library. Focelle does not operate a photo library or photo-storage service.
